...
public final class CryptoUtilities {
    ...
    public static boolean isEven(NaturalNumber n) {
        ...
        NaturalNumber remainder = temp.divide(new NaturalNumber2(2));
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        if (p.isZero()) {
            ...
            if (isEven(p)) {
                remainder = p.divide(new NaturalNumber2(2));
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber tempWitness = new NaturalNumber2(w);
        NaturalNumber tempN = new NaturalNumber2(n);
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        for (int i = 0; i < numberOfCandidates; i++) {
            if (n.compareTo(new NaturalNumber2(THREE)) <= 0) {
                ...
                if (rnd.compareTo(new NaturalNumber2(0)) == 0) {
                    rnd.add(new NaturalNumber2(2));
                } else if (rnd.compareTo(new NaturalNumber2(1)) == 0) {
                    rnd.add(new NaturalNumber2(1));
                } else if (rnd.compareTo(tempN) == 0) {
                    rnd.subtract(new NaturalNumber2(1));
                } else if (rnd.compareTo(n) == 0) {
                    rnd.subtract(new NaturalNumber2(2));
                }
                isPrime = !isWitnessToCompositeness(rnd, n);
            }
        }
        return isPrime;
    }
